...
from langchain_community.vectorstores import Chroma  # Correct import for ChromaDB
from langchain_openai import OpenAIEmbeddings
from langchain.llms import OpenAI
import openai

# ✅ Securely Load OpenAI API Key
openai_api_key = st.secrets.get("OPENAI_API_KEY", None)  # Streamlit secrets method
